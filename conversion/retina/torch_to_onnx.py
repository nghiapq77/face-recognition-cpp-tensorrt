...
parser.add_argument('-m', '--trained_model', default='../../weights/torch/retina/mobilenet0.25_Final.pth',
...
if __name__ == '__main__':
    ...
    output_onnx = f'retina-{args.network}-{args.height}x{args.width}.onnx'
    print("==> Exporting model to ONNX format at '{}'".format(output_onnx))
    input_names = ["input_det"]
    output_names = ["output_det0", "output_det1"]
    torch_out = torch.onnx.export(net, inputs, output_onnx, export_params=True, verbose=True, opset_version=11,
